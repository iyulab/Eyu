...
/// <see cref="LinkagePipeline.Analyze"/> to <see cref="LinkageClassifier.Classify"/> and
/// <see cref="FellegiSunterEstimator.Estimate"/>. All defaults match what those two methods
/// already used, so passing no options changes nothing — a caller only needs this once observed
/// precision/recall from a live validation cycle calls for different thresholds (design rationale
/// §D of the base feature; decision 4 of the follow-up design).
/// </summary>
